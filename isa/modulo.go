...
func (i *Modulo) Load(x flamego.Context) (uint64, uint64, uint64) {
...
func (i *Modulo) Format(x flamego.Context, a uint64) uint64 {
	return a
}

func (i *Modulo) Store(x flamego.Context, a uint64) {
