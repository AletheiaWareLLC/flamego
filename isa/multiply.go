...
func (i *Multiply) Load(x flamego.Context) (uint64, uint64, uint64) {
...
func (i *Multiply) Execute(x flamego.Context, a, b, c uint64) uint64 {
	return a * b
}

func (i *Multiply) Format(x flamego.Context, a uint64) uint64 {
	return a
}

func (i *Multiply) Store(x flamego.Context, a uint64) {
	// Write Destination Register
	x.WriteRegister(i.DestinationRegister, a)
}

func (i *Multiply) Retire(x flamego.Context) {
